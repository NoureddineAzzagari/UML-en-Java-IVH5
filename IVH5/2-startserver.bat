...
start java -cp .\bin;.\libs\log4j-1.2.17.jar;.\libs\mysql-connector-java-5.1.32.jar edu.avans.ivh5.server.model.main.LibraryServer -properties resources/breda.properties

:: Start tweede server voor inter-server communicatie.
start java -cp .\bin;.\libs\log4j-1.2.17.jar;.\libs\mysql-connector-java-5.1.32.jar edu.avans.ivh5.server.model.main.LibraryServer -properties resources/oosterhout.properties
